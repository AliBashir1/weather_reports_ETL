...
CREATE TABLE IF NOT EXISTS weather_reports_tbl (
  ...
  temp_f        NUMERIC DEFAULT NULL,
  feelslike_f   NUMERIC DEFAULT NULL,
  condition     VARCHAR(50) DEFAULT NULL,
  wind_mph      NUMERIC DEFAULT NULL,
  wind_degree   INT DEFAULT NULL,
  wind_dir      VARCHAR(5) DEFAULT NULL,
  pressure_mb   NUMERIC DEFAULT NULL,
  precip_mm     NUMERIC DEFAULT NULL,
  humidity      INT DEFAULT NULL,
  cloud         INT DEFAULT NULL,
  vis_miles     NUMERIC DEFAULT NULL,
  uv            NUMERIC DEFAULT NULL,
  gust_mph      NUMERIC DEFAULT NULL,
