...
def fetch_daily_staging_data(s3_client: BaseClient) -> list:
    ...
    keys = [f"weather-reports/{datetime.date.today() - timedelta(days=1)}/12-AM",
            f"weather-reports/{datetime.date.today() - timedelta(days=1)}/6-AM",
            f"weather-reports/{datetime.date.today() - timedelta(days=1)}/12-PM",
            f"weather-reports/{datetime.date.today() - timedelta(days=1)}/6-PM"]
...
if __name__ == '__main__':
    ...
    from etl_processes.load_data.load_weather_reports_tbl import load_weather_reports_tbl
