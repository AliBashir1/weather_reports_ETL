...
# ETL
from src.etl_processes.fetch_data.fetch_weather_reports import fetch_weather_reports
...
default_args = {
    "owner": "Ali Bashir",
    "start_date": dt.datetime(2024, 2, 14, 0, 0, 0, tzinfo=pendulum.timezone("America/New_York")),
    "email_on_retry": True,
...
with DAG(
    ...
    is_zipcodes_file_available = FileSensor(
        ...
        filepath="project_files/src/data/zipcodes.csv",
        recursive=False,
        mode="reschedule",
        retries=1,
        retry_delay=5,
...
start >> is_zipcodes_file_available >> preliminary_check >> fetch_weather_reports_api >> trig_send_job_reports_dag >> end
