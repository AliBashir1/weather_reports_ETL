...
if __name__ == "__main__":
    ...
    from project_files.src.weather_reports_etl.connections import get_mysql_connections
    from project_files.src.weather_reports_etl.connections.aws_connections import get_s3_client
    from project_files.src.weather_reports_etl.etl_processes.fetch_data.fetch_staging_data_s3 import fetch_daily_reports
